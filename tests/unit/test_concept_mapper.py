...
class TestConceptMapper:
    ...
    def test_load_icd_mapping_with_full_columns(self, concept_mapper):
        """Test ICD mapping loads mapGroup, mapPriority, correlationId columns."""
        with tempfile.NamedTemporaryFile(mode="w", suffix=".tsv", delete=False) as f:
            tsv_path = f.name
        try:
            df_content = """referencedComponentId	mapTarget	active	mapGroup	mapPriority	correlationId
409681000000102	Diabetes active	1	1	1	723899007"""
...
class TestConfidenceScoring:
    ...
    def test_confidence_calculation_with_category_id(self, concept_mapper):
    ...
    def test_confidence_calculation_high_correlation(self, concept_mapper):
    ...
    def test_confidence_calculation_low_correlation(self, concept_mapper):
    ...
    def test_confidence_calculation_category_id_only(self, concept_mapper):
...
class TestConceptMapperEdgeCasesDetailed:
    ...
    def test_batch_map_concepts_single_cui_with_vocabs(self, concept_mapper):
        result = concept_mapper.batch_map_concepts(["73211009"], ["ICD-10"])

        assert "73211009" in result
        assert "ICD-10" in result["73211009"]

    def test_multi_hop_mapping_with_rxnorm(self):
        from src.snomed_methods.concept_mapper import ConceptMapper
...
class TestConceptMapperEdgeCases:
    ...
    def test_multi_hop_mapping_empty_vocabs(self):
        from src.snomed_methods.concept_mapper import ConceptMapper
    ...
    def test_export_mappings_empty_list(self, concept_mapper):
        import tempfile
    ...
    def test_batch_map_concepts_empty_list(self, concept_mapper):
        result = concept_mapper.batch_map_concepts([])

        assert result == {}

    def test_map_bidirectional_unknown_vocab(self, concept_mapper):
...
class TestUMLSCIMapperEdgeCases:
    ...
    def test_get_all_mappings_with_snomed(self):
        from src.snomed_methods.umlsci_mapper import UMLSCIMapper
    ...
    def test_get_all_mappings_with_umls(self):
        from src.snomed_methods.umlsci_mapper import UMLSCIMapper
    ...
    def test_export_mappings_empty_list(self):
        import tempfile
...
class TestUMLSCIMapperConvenienceFunctions:
    ...
    def test_map_to_umls_convenience(self):
...
class TestBatchOperations:
    ...
    def test_batch_map_concepts_with_empty_vocabs(self):
        from src.snomed_methods.concept_mapper import ConceptMapper
    ...
    def test_get_all_mappings_with_empty_cui(self):
        from src.snomed_methods.concept_mapper import ConceptMapper
...
class TestConceptMapperPathsAndConfig:
    ...
    def test_get_refset_name_with_icd_file(self, concept_mapper):
        from src.snomed_methods.concept_mapper import ConceptMapper
    ...
    def test_get_refset_name_with_loinc_file(self, concept_mapper):
        from src.snomed_methods.concept_mapper import ConceptMapper
    ...
    def test_get_refset_name_default(self, concept_mapper):
        from src.snomed_methods.concept_mapper import ConceptMapper
...
class TestConceptMapperAutoDetectPaths:
    ...
    def test_auto_detect_with_invalid_path(self, concept_mapper):
        from src.snomed_methods.concept_mapper import ConceptMapper

        mapper = ConceptMapper(uk_path="/nonexistent/path")
        assert mapper.uk_path == "/nonexistent/path"

    def test_map_to_icd_after_load(self):
        from src.snomed_methods.concept_mapper import ConceptMapper
    ...
    def test_batch_map_concepts_single_cui_all_vocabularies(self, concept_mapper):
        result = concept_mapper.batch_map_concepts(["409681000000102"])
