...
class TestUMNSRSDataset:
    ...
    def test_get_pairs_structure(self):
    ...
    def test_download_label_conversion(self):
    ...
    def test_download_label_conversion_disabled(self):
...
class TestBenchmarkEvaluation:
    ...
    def test_spearman_correlation(self):
        ...
        corr, p_value = spearman_correlation(predictions, references)
...
class TestRankingMetrics:
    ...
    def test_average_precision_basic(self):
        ...
        # At position 1: A is relevant -> prec=1/1, at position 3: C is relevant -> prec=2/3
